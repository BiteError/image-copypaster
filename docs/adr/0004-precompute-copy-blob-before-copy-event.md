...
Do not move blob creation into `handleCopy`/the `copy` handler, even to simplify the flow — it would reintroduce the activation-window race that item 12 of `src/INITIALSPEC.md` explicitly calls out.
